...
def build_csv_commands_panel(app: "CsvViewerApp"):
    ...
    btn_add_row = ctk.CTkButton(frame, text="Add Row", command=app.add_row)
    btn_add_row.grid(row=1, column=0, padx=10, pady=5, sticky="ew")

    btn_add_column = ctk.CTkButton(frame, text="Add Column", command=app.add_column)
    btn_add_column.grid(row=2, column=0, padx=10, pady=5, sticky="ew")

    btn_delete_row = ctk.CTkButton(frame, text="Delete Row", command=app.delete_row)
    btn_delete_row.grid(row=3, column=0, padx=10, pady=5, sticky="ew")

    btn_delete_column = ctk.CTkButton(frame, text="Delete Column", command=app.delete_column)
